 ...
 *
 * NOTE: AppointmentTracker is only defined in some HTML pages (index.html, dental_homepage.html).
 * In dental_admin_enhanced2.html it does NOT exist — the admin portal uses AdminPortal class instead.
 * We use a safe base class fallback so this file never throws a ReferenceError.
 */
const _AppointmentTrackerBase = (typeof AppointmentTracker !== 'undefined') ? AppointmentTracker : class { constructor() {} };
class SupabaseAppointmentTracker extends _AppointmentTrackerBase {
    constructor() {
        super();
        this.supabase = db;
...
class SupabaseFeedbackManager {
    constructor() {
        this.supabase = db;
        this.tableName = 'feedback_entries';
